...
export const sortedProducts = state => {
  // call .slice() to ensure that our sorting is performed on a new copy of the array rather than the original
  // If we omit this, then we'd be greeted by a host of console warning messages stating that we shouldn't be directly mutating the state outside of our mutations
